<div class="sidebar">
  <ul>
    <li><a href="/MODERN_HMS/frontend/views/admin/dashboard.php">Dashboard</a></li>
    <li><a href="/MODERN_HMS/frontend/views/admin/doctor_list.php">Doctor List</a></li>
    <li><a href="/MODERN_HMS/frontend/views/admin/patient_list.php">Patient List</a></li>
